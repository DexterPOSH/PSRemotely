...
$RemotelyTestFile = "$env:BHProjectPath\Tests\Integration\artifacts\Localhost.CustomVariable.PSRemotely.ps1"
...
try {
	...
	Describe "PSRemotely custom variables usage, with PS V$($PSVersion)" -Tag Integration {
